    ...
    <div className="space-y-6">
      ...
      <section className="bg-white rounded-2xl p-6 shadow-soft border border-coral-100/50 max-w-xl">
        <div className="flex items-center gap-4 mb-6">
          <div className="w-16 h-16 rounded-full bg-coral-500 text-white flex items-center justify-center font-extrabold text-xl">{user?.full_name?.charAt(0) || 'SA'}</div>
          <div>
            <div className="font-extrabold text-lg text-slate-900">{user?.full_name}</div>
